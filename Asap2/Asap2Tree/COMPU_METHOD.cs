namespace Asap2
{
    ...
    {
        [Element(6)] public COEFFS coeffs;

        [Element(7)] public COEFFS_LINEAR coeffs_linear;
        ...
        /// </summary>
        [Element(9)] public FORMULA formula;
        ...
        ///     The latter contains status information about the numerical part such as providing an error or describing the
        ///     quality of the measurement.
        /// </summary>
        [Element(11, IsArgument = true, Name = "STATUS_STRING_REF")]
        public string status_string_ref;

        public COMPU_METHOD(Location location, string Name, string LongIdentifier, ConversionType conversionType,
            string Format, string Unit) : base(location)
        {
            this.Name = Name;
