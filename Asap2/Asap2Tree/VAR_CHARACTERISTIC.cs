...
namespace Asap2
{
    ...
    public class VAR_CHARACTERISTIC : Asap2Base
    {
        ...
        [Element(3)] public VAR_ADDRESS var_address;
    ...
    ///     The number of addresses in this list must match the number of variants from the referenced variant criteria (
    ///     <see cref="VAR_CRITERION" />).
    /// </summary>
    [Base]
