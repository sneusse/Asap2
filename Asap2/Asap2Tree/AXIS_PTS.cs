...
namespace Asap2
{
    ...
    ///     The keyword describes the properties of an axis, such as its address in memory, references to the input variable (
    ...
    {
        [Element(11, IsList = true)] public List<ANNOTATION> annotation = new List<ANNOTATION>();

        [Element(12)] public BYTE_ORDER byte_order;

        [Element(13)] public CALIBRATION_ACCESS calibration_access;

        [Element(12)] public DEPOSIT deposit;
        ...
        [Element(24, IsList = true)] public List<IF_DATA> if_data = new List<IF_DATA>();

        [Element(25)] public MONOTONY monotony;
        ...
        [Element(29)] public SYMBOL_LINK symbol_link;

        public AXIS_PTS(Location location, string Name, string LongIdentifier, ulong Address, string InputQuantity,
            string Deposit, decimal MaxDiff, string Conversion, ulong MaxAxisPoints, decimal LowerLimit,
            decimal UpperLimit) : base(location)
        {
            this.Name = Name;
        ...
        public ulong MaxAxisPoints { get; private set; }
        ...
        public void Validate(IErrorReporter errorReporter, MODULE module)
        {
...

            {
                ...
                if (!module.Record_layouts.ContainsKey(Deposit))
                    reportErrorOrWarning(string.Format("Referenced RECORD_LAYOUT '{0}' not found", Conversion), false,
                        errorReporter);
            }
            ...
            if (InputQuantity != "NO_INPUT_QUANTITY")
                ...
                if (!module.AxisPtsCharacteristicMeasurement.ContainsKey(InputQuantity))
                    reportErrorOrWarning(string.Format("Referenced inputQuantity '{0}' not found", InputQuantity),
                        false, errorReporter);
