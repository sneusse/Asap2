...
namespace Asap2.tools
{
    public class Remover
    {
        ...
        /// <summary>
        ///     Search base elements (elements that is handled by the <see cref="MODULE" />) and delete references to named
        ///     <see cref="CHARACTERISTIC" />, <see cref="MEASUREMENT" /> or <see cref="AXIS_PTS" />.
        /// </summary>
        ...
        private static void deleteReferencesToCharacteristicMeasurementAxis_pts(ref MODULE module, List<string> name)
        {
            foreach (var function in module.Functions.Values)
            {
                if (function.def_characteristic != null)
                {
                    var objToDelete = new List<string>();
                    foreach (var obj in function.def_characteristic.def_characteristics.Where(x => name.Contains(x)))
                        objToDelete.Add(obj);

                    foreach (var obj in objToDelete) function.def_characteristic.def_characteristics.Remove(obj);
                }
                ...
                if (function.ref_characteristic != null)
                {
                    ...
                    foreach (var obj in objToDelete) function.ref_characteristic.reference.Remove(obj);
                }
                ...
                if (function.in_measurement != null)
                {
                    ...
                    foreach (var obj in objToDelete) function.in_measurement.measurements.Remove(obj);
                }
                ...
                if (function.loc_measurement != null)
                {
                    ...
                    foreach (var obj in objToDelete) function.loc_measurement.measurements.Remove(obj);
                }
                ...
                if (function.out_measurement != null)
                {
                    ...
                    foreach (var obj in objToDelete) function.out_measurement.measurements.Remove(obj);
                }
            }
            ...
            foreach (var group in module.Groups.Values)
            {
                if (group.ref_characteristic != null)
                {
                    ...
                    foreach (var obj in objToDelete) group.ref_characteristic.reference.Remove(obj);
                }
                ...
                if (group.ref_measurement != null)
                {
                    ...
                    foreach (var obj in objToDelete) group.ref_measurement.reference.Remove(obj);
                }
            }
        }
